...
const NAV_ITEMS: NavItem[] = [
  { href: "/restaurant", label: "Home", icon: HomeIcon },
  { href: "/restaurant/scan", label: "Scan", icon: CameraIcon },
  { href: "/restaurant/rewards", label: "Rewards", icon: GiftIcon },
  { href: "/restaurant/profile", label: "Profile", icon: UserIcon },
];
    ...
    >
      <div className="mx-auto flex max-w-md items-stretch justify-between px-2">
        {NAV_ITEMS.map(({ href, label, icon: Icon }) => {
          const isActive =
            href === "/restaurant" ? pathname === "/restaurant" : pathname.startsWith(href);
